...
public:
	__forceinline const char* GetString( ) {
		return Utilities::GetMethod< const char*( __thiscall* )( decltype( this ) ) >( this, GETSTRING )( this );
	}

	__forceinline float GetFloat( ) {
		return Utilities::GetMethod< float( __thiscall* )( decltype( this ) ) >( this, GETFLOAT )( this );
	}

	__forceinline int GetInt( ) {
		return Utilities::GetMethod< int( __thiscall* )( decltype( this ) ) >( this, GETINT )( this );
	}

	__forceinline void SetValue( const char* value ) {
		return Utilities::GetMethod< void( __thiscall* )( decltype( this ), const char* ) >( this, SETVALUE_SZ )( this, value );
	}

	__forceinline void SetValue( float value ) {
		return Utilities::GetMethod< void( __thiscall* )( decltype( this ), float ) >( this, SETVALUE_FLOAT )( this, value );
	}

	__forceinline void SetValue( int value ) {
		return Utilities::GetMethod< void( __thiscall* )( decltype( this ), int ) >( this, SETVALUE_INT )( this, value );
	}
};
...
public:
	...
	void ConsoleColorPrintf( const Color& color, const char* format, arguments ... args ) {
		return Utilities::GetMethod< void( __cdecl* )( decltype( this ), const Color&, const char*, ... )>( this, CONSOLECOLORPRINTF )( this, color, format, args... );
	}
};
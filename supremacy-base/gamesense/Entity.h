...
public:
	...
	__forceinline vec3_t &GetRenderOrigin() {
		return Utilities::GetMethod< vec3_t &(__thiscall *)(void *) >(renderable(), 1)(renderable());
	}

	__forceinline ang_t &GetRenderAngles() {
		return Utilities::GetMethod< ang_t &(__thiscall *)(void *) >(renderable(), 2)(renderable());
	}

	__forceinline const model_t *GetModel() {
		return Utilities::GetMethod< const model_t *(__thiscall *)(void *) >(renderable(), 8)(renderable());
	}

	__forceinline void DrawModel(int flags = STUDIO_RENDER, const RenderableInstance_t &instance = {}) {
		return Utilities::GetMethod< void(__thiscall *)(void *, int, const RenderableInstance_t &)>(renderable(), 9)(renderable(), flags, instance);
	}

	__forceinline bool SetupBones(matrix3x4_t *out, int max, int mask, float time) {
		return Utilities::GetMethod< bool(__thiscall *)(void *, matrix3x4_t *, int, int, float)>(renderable(), 13)(renderable(), out, max, mask, time);
	}
	...
	__forceinline void Release() {
		return Utilities::GetMethod< void(__thiscall *)(void *) >(networkable(), 1)(networkable());
	}

	__forceinline ClientClass *GetClientClass() {
		return Utilities::GetMethod< ClientClass *(__thiscall *)(void *) >(networkable(), 2)(networkable());
	}

	__forceinline void OnDataChanged(DataUpdateType_t type) {
		return Utilities::GetMethod< void(__thiscall *)(void *, DataUpdateType_t) >(networkable(), 5)(networkable(), type);
	}

	__forceinline void PreDataUpdate(DataUpdateType_t type) {
		return Utilities::GetMethod< void(__thiscall *)(void *, DataUpdateType_t) >(networkable(), 6)(networkable(), type);
	}

	__forceinline void PostDataUpdate(DataUpdateType_t type) {
		return Utilities::GetMethod< void(__thiscall *)(void *, DataUpdateType_t) >(networkable(), 7)(networkable(), type);
	}

	__forceinline bool dormant() {
		return Utilities::GetMethod< bool(__thiscall *)(void *) >(networkable(), 9)(networkable());
	}

	__forceinline int index() {
		return Utilities::GetMethod< int(__thiscall *)(void *) >(networkable(), 10)(networkable());
	}

	__forceinline void SetDestroyedOnRecreateEntities() {
		return Utilities::GetMethod< void(__thiscall *)(void *) >(networkable(), 13)(networkable());
	}

	// normal table.
	__forceinline const vec3_t &GetAbsOrigin() {
		return Utilities::GetMethod< const vec3_t &(__thiscall *)(void *) >(this, 10)(this);
	}

	__forceinline const ang_t &GetAbsAngles() {
		return Utilities::GetMethod< const ang_t &(__thiscall *)(void *) >(this, 11)(this);
	}

	__forceinline bool IsPlayer() {
		return Utilities::GetMethod< bool(__thiscall *)(void *) >(this, ISPLAYER)(this);
	}

	__forceinline bool IsBaseCombatWeapon() {
		return Utilities::GetMethod< bool(__thiscall *)(void *) >(this, ISBASECOMBATWEAPON)(this);
	}
...
public:
	...
	__forceinline ulong_t GetRefEHandle() {
		...
		return Utilities::GetMethod< GetRefEHandle_t >(this, GETREFEHANDLE)(this);
	}
	...
	__forceinline void BuildTransformations(CStudioHdr *hdr, vec3_t *pos, quaternion_t *q, const matrix3x4_t &transform, int mask, uint8_t *computed) {
		...
		return Utilities::GetMethod< BuildTransformations_t >(this, BUILDTRANSFORMATIONS)(this, hdr, pos, q, transform, mask, computed);
	}
	...
	__forceinline void StandardBlendingRules(CStudioHdr *hdr, vec3_t *pos, quaternion_t *q, float time, int mask) {
		...
		return Utilities::GetMethod< StandardBlendingRules_t >(this, STANDARDBLENDINGRULES)(this, hdr, pos, q, time, mask);
	}

	__forceinline float GetFOV() {
		return Utilities::GetMethod< float(__thiscall *)(decltype(this)) >(this, GETFOV)(this);
	}

	__forceinline const vec3_t &WorldSpaceCenter() {
		return Utilities::GetMethod< const vec3_t &(__thiscall *)(void *) >(this, WORLDSPACECENTER)(this);
	}

	__forceinline void GetEyePos(vec3_t *pos) {
		Utilities::GetMethod< void(__thiscall *)(decltype(this), vec3_t *) >(this, GETEYEPOS)(this, pos);
	}
	...
	__forceinline void UpdateClientSideAnimation() {
		return Utilities::GetMethod< void(__thiscall *)(decltype(this)) >(this, UPDATECLIENTSIDEANIMATION)(this);
	}

	__forceinline void UpdateCollisionBounds() {
		return Utilities::GetMethod< void(__thiscall *)(decltype(this)) >(this, UPDATECOLLISIONBOUNDS)(this);
	}
...
public:
	...
	__forceinline int GetMaxClip1() {
		return Utilities::GetMethod< int(__thiscall *)(void *) >(this, GETMAXCLIP1)(this);
	}

	__forceinline void SetGloveModelIndex(int index) {
		return Utilities::GetMethod< void(__thiscall *)(void *, int) >(this, SETMODELINDEX)(this, index);
	}

	__forceinline WeaponInfo *GetWpnData() {
		return Utilities::GetMethod< WeaponInfo *(__thiscall *)(void *) >(this, GETWPNDATA)(this);
	}

	__forceinline float GetInaccuracy() {
		return Utilities::GetMethod< float(__thiscall *)(void *) >(this, GETINACCURACY)(this);
	}

	__forceinline float GetSpread() {
		return Utilities::GetMethod< float(__thiscall *)(void *) >(this, GETSPREAD)(this);
	}

	__forceinline void UpdateAccuracyPenalty() {
		return Utilities::GetMethod< void(__thiscall *)(void *) >(this, UPDATEACCURACYPENALTY)(this);
	}
	...
	__forceinline std::string GetLocalizedName() {
		...
		return Utilities::WideToMultiByte(g_csgo.m_localize->Find(item_def->GetItemBaseName()));
	}
};
...
public:
	...
	__forceinline bool ShouldHitEntity(Entity *entity, int contents_mask) {
		...
		return Utilities::GetMethod< bool(__thiscall *)(void *, Entity *, int) >(real_vmt, 0)(real_vmt, entity, contents_mask);
	}
	...
	__forceinline void SetPassEntity(Entity *pass_ent1) {
		...
		// Utilities::GetMethod< void (__thiscall *)( void *, Entity* ) >( m_vmt, 2 )( m_vmt, pass_ent1 );
	}

	__forceinline void SetCollisionGroup(int collision_group) {
		m_collision_group = collision_group;

		// Utilities::GetMethod< void (__thiscall *)( void *, int ) >( m_vmt, 3 )( m_vmt, collision_group );
	}
};
...
public:
	...
	__forceinline bool ShouldHitEntity(Entity *entity, int contents_mask) {
		...
		return Utilities::GetMethod< bool(__thiscall *)(void *, Entity *, int) >(m_vmt, 0)(m_vmt, entity, contents_mask);
	}
	...
	__forceinline void SetPassEntity2(Entity *pass_ent2) {
		m_pass_ent2 = pass_ent2;
		// Utilities::GetMethod< void (__thiscall *)( void *, Entity* ) >( m_vmt, 4 )( m_vmt, pass_ent2 );
	}
};
...
public:
	...
	__forceinline t GetClientEntity( int index ) {
		return Utilities::GetMethod< t( __thiscall* )( decltype( this ), int ) >( this, GETCLIENTENTITY )( this, index );
	}

	template< typename t = Entity* >
	__forceinline t GetClientEntityFromHandle( EHANDLE handle ) {
		return Utilities::GetMethod< t( __thiscall* )( decltype( this ), EHANDLE ) >( this, GETCLIENTENTITYFROMHANDLE )( this, handle );
	}

	template< typename t = Entity* >
	__forceinline t GetClientEntityFromHandle( ulong_t handle ) {
		return Utilities::GetMethod< t( __thiscall* )( decltype( this ), ulong_t ) >( this, GETCLIENTENTITYFROMHANDLE )( this, handle );
	}

	__forceinline int GetHighestEntityIndex( ) {
		return Utilities::GetMethod< int( __thiscall* )( decltype( this ) ) >( this, GETHIGHESTENTITYINDEX )( this );
	}
};
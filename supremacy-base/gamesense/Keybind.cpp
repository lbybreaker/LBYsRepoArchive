...
const std::string keynames[] = {
	...
	XOR( "BACK" ), XOR( "TAB" ), XOR( "[10]" ), XOR( "[11]" ), XOR( "NUM5" ), XOR( "ENTER" ), XOR( "[14]" ), XOR( "[15]" ), XOR( "SHFT" ),
	XOR( "CTRL" ), XOR( "ALT" ), XOR( "[19]" ), XOR( "CAPS" ), XOR( "[21]" ), XOR( "[22]" ), XOR( "[23]" ), XOR( "[24]" ), XOR( "[25]" ),
	XOR( "[26]" ), XOR( "ESC" ), XOR( "[28]" ), XOR( "[29]" ), XOR( "[30]" ), XOR( "[31]" ), XOR( "SPACE" ), XOR( "PGUP" ), XOR( "PGDWN" ), XOR( "END" ),
	XOR( "HOME" ), XOR( "LEFT" ), XOR( "UP" ), XOR( "RIGHT" ), XOR( "DOWN" ), XOR( "[41]" ), XOR( "[42]" ), XOR( "[43]" ), XOR( "[44]" ), XOR( "INS" ),
	XOR( "DEL" ), XOR( "[47]" ), XOR( "0" ), XOR( "1" ), XOR( "2" ), XOR( "3" ), XOR( "4" ), XOR( "5" ), XOR( "6" ), XOR( "7" ), XOR( "8" ), XOR( "9" ),
	...
	XOR( "R" ), XOR( "S" ), XOR( "T" ), XOR( "U" ), XOR( "V" ), XOR( "W" ), XOR( "X" ), XOR( "Y" ), XOR( "Z" ),	XOR( "LWIN" ), XOR( "RWIN" ),
	XOR( "APP" ), XOR( "[94]" ),  XOR( "[95]" ), XOR( "NUM0" ), XOR( "NUM1" ), XOR( "NUM2" ), XOR( "NUM3" ), XOR( "NUM4" ), XOR( "NUM5" ),
	XOR( "NUM6" ), XOR( "NUM7" ), XOR( "NUM8" ),  XOR( "NUM9" ), XOR( "NUMMUL" ), XOR( "NUMPL" ), XOR( "[108]" ), XOR( "NUMSUB" ), XOR( "NUMDEC" ),
	XOR( "NUMDIV" ), XOR( "F1" ), XOR( "F2" ),  XOR( "F3" ), XOR( "F4" ), XOR( "F5" ), XOR( "F6" ), XOR( "F7" ), XOR( "F8" ), XOR( "F9" ), XOR( "F10" ),
	...
	XOR( "[143]" ), XOR( "NUMLOCK" ), XOR( "BREAK" ), XOR( "[146]" ), XOR( "[147]" ), XOR( "[148]" ), XOR( "[149]" ), XOR( "[150]" ), XOR( "[151]" ), XOR( "[152]" ),
	...
	XOR( "[228]" ), XOR( "[229]" ), XOR( "[230]" ), XOR( "[231]" ), XOR( "[232]" ), XOR( "[233]" ), XOR( "RWIN" ), XOR( "[235]" ), XOR( "[236]" ), XOR( "[237]" ),
	XOR( "[238]" ), XOR( "[239]" ), XOR( "[240]" ), XOR( "LWIN" ), XOR( "[242]" ), XOR( "[243]" ), XOR( "[244]" ), XOR( "[245]" ), XOR( "[246]" ), XOR( "[247]" ),

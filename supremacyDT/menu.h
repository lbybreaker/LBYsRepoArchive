...
public:
	void init( ) {
		...
		shot_chams.setup(XOR("shot chams"), XOR("shot chams"));
		RegisterElement(&shot_chams);

		shot_chams_col.setup(XOR("shot chams color"), XOR("shotchamcol"), colors::white);
		shot_chams_col.AddShowCallback(callbacks::AreOnshotChamsOn);
		RegisterElement(&shot_chams_col);
...
public:
	void init( ) {
		...
		indicators.setup( XOR( "indicators" ), XOR( "indicators" ), { XOR( "lby" ), XOR("doubletap"), XOR("fake lag"), XOR("lag compensation"), XOR("fake latency")});
...
public:
	void init( ) {
		...
		slidewalk.setup(XOR("slidewalk"), XOR("slidewalk"));
